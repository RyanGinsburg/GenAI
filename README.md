...
> Currently: Step 4 (research_agent.py) is done — the two bugs found in the
> 2026-09-03 QA review are fixed and confirmed against the live Claude API.
> See CLAUDE.md's "Current status" section and `qa/research_agent_review.md`
> for details.
...
> BUILD_PROMPTS.md's Step 5 prompt).
